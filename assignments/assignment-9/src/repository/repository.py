...
class MemoRepoStudent:
    ...
    def get_by_id(self, id_:int):
        """
        returns the student by its id
        :param id_: the id of the student
        :return: the student if it exists or None
        """
        return self._students_data.get(id_)
...
class MemoRepoAssignment:
    ...
    def get_by_id(self, id_:int):
        ...
        :param id_: the id of the assignment
        :return: the assignment if it exists or None
        """
        return self._assignments_data.get(id_)
